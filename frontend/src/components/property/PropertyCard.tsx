...
export function PropertyCard({ property, onClick }: PropertyCardProps) {
  return (
    ...
    >
      <div className="h-48 bg-petrol-50 flex items-center justify-center">
        <img
      ...
      <div className="p-4">
        <div className="flex items-start justify-between gap-2 mb-2">
          ...
          {property.accepts_altscore && <Badge variant="success">AltScore</Badge>}
        </div>
        <p className="text-petrol-400 text-sm mb-2 line-clamp-1">{property.address}</p>
